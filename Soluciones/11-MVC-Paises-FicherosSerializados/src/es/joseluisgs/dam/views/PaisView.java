...
import es.joseluisgs.dam.services.StoragePaisesSerializedFile;
...
public class PaisView {
    ...
    private final PaisController paisController = new PaisController(new PaisRepository(), new StoragePaisesSerializedFile());
